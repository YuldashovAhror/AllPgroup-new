                        ...
                        @foreach($categories as $key=>$category)
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-xs btn-success" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter{{ $category->id }}Edit"><i class="bx bx-pencil"></i>Изменить</button>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 50vw">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('dashboard.newcategory.update', $category) }}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        {{ method_field('put') }}
                                                        <div class="card-body">
                                                            </div>
                                    ...
                                    <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter{{ $category->id }}"><i class="bx bx-trash"></i>Удалить</button>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="{{ route('dashboard.newcategory.destroy', $category->id) }}" method="post">
                                                        @csrf
                                                        {{ method_field('delete') }}
