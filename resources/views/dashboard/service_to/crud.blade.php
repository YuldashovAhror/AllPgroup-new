                        ...
                        @foreach($servicetos as $key=>$serviceto)
                            <tr>
                                ...
                                <td class="text-center">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 50vw">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('dashboard.serviceto.update', $serviceto) }}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        {{ method_field('put') }}
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="col-6 text-center">
                                                                            <img style="height: 100px; width: 100px" src="{{ $serviceto->photo }}">
                                                                        </div>
                                    ...
                                    <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter{{ $serviceto->id }}"><i class="bx bx-trash"></i>Удалить</button>
                                    <div class="modal fade" id="exampleModalCenter{{ $serviceto->id }}" tabindex="-1" aria-labelledby="exampleModalCenter" style="display: none;" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="{{ route('dashboard.serviceto.destroy', $serviceto->id) }}" method="post">
                                                        @csrf
                                                        {{ method_field('delete') }}
