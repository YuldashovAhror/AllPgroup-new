                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            @foreach ($news as $new)
                                <tr>
                                    <th scope="row">{{ $k }}</th>
                                    <td><img src="{{ $new->photo }}" alt="" style="height: 100px; width: 200px">
                                    </td>
                                    <td><img src="{{ $new->second_photo }}" alt=""
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="modal fade" id="exampleModalCenter{{ $new->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form action="{{ route('dashboard.news.destroy', $new) }}"
                                                            method="post">
                                                            @csrf
                                                            {{ method_field('delete') }}
