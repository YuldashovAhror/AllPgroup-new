                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th scope="col">Категория новостей</th>
                        ...
                        @foreach($news as $new)
                            <tr>
                                <th scope="row">{{ $k }}</th>
                                <td><img src="{{ $new->photo }}" alt="" style="height: 100px; width: 200px"></td>
                                <td><img src="{{ $new->second_photo }}" alt="" style="height: 100px; width: 200px"></td>
                                <td>{{ $new->name_ru }}</td>
                                ...
                                <td class="text-center">
                                    ...
                                    <button class="btn btn-xs btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter{{ $new->id }}"><i class="bx bx-trash"></i>Удалить</button>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="{{ route('dashboard.news.destroy', $new) }}" method="post">
                                                        @csrf
                                                        {{ method_field('delete') }}
